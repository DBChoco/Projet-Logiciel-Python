...
patm = 101315  # *(1-(0.0065*altitude/288.15))**5.255 #pression actuelle totale. Autrement dit la pression ambiante dans le lieu ou se trouve le séchoir.(en Pa)
...
a = 0  # Permet de ne pas prendre en compte l'expression en cosinus dans la formule de Tsky, assignez une valeur de 0
# ou 1 dépendant du cas.
...
Tsky = Tamb * (0.711 + (0.0056 * Trose) + (7.3 * (10 ** -5) * Trose ** 2) +(0.013*a*(math.cos((2 * math.pi * t) / 24)))**(1/4)) #Tsky
